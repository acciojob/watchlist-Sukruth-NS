...
public class MovieController {
    ...
    public ResponseEntity<Movie> getMovieByName(@PathVariable String name){
        Movie movie = movieService.getMovieByName(name); // Assign student by calling service layer method
    ...
    public ResponseEntity<Director> getDirectorByName(@PathVariable String name){
        Director director = movieService.getDirectorByName(name); // Assign student by calling service layer method
